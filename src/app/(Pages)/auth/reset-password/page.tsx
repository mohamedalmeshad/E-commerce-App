...
import { MailIcon, LockIcon, ChevronLeftIcon } from 'lucide-react'
    ...
    async function onSubmit(data: ResetPasswordFormData) {
        ...
        try {
            ...
            if (result.token) {
                ...
                setError(result.message || "Identity reset failed.");
            }
        } catch (error) {
            console.log(error)
        ...
        <div className="container mx-auto px-4 min-h-[80vh] flex justify-center items-center py-16">
            <div className="w-full max-w-[480px] space-y-8">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Set your new password</p>
                </div>
                        ...
                        <form id="reset-password-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            <FieldGroup className="space-y-6">
                                ...
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid}>
                                            <FieldLabel htmlFor="reset-email" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1 mb-2 block">
                                                Confirm Email
                                            </FieldLabel>
                                ...
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <Field data-invalid={fieldState.invalid}>
                                            <FieldLabel htmlFor="reset-password" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1 mb-2 block">
                                                New Password
                                            </FieldLabel>
                                            <div className="relative group/field">
                            ...
                            <div className="pt-4">
                                <Button type="submit" disabled={isLoading} className="w-full h-16 rounded-2xl text-sm font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary/20 hover:scale-[1.02] transition-transform cursor-pointer">
                                    {isLoading ? <Spinner className="size-6 text-white" /> : "Confirm & Save"}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
